...
use archivindex_test_support::strategies::tokens_of;
use chrono::{TimeZone as _, Utc};
use proptest::prelude::*;
use proptest::sample::select;

use crate::format::cdxj::{ConformingFields, Fields, Item};
use crate::format::classic::Record;
...
/// A classic header and a record with the same number of values; individual values may be empty.
