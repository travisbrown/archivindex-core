...
//!
//! The functions reproduce the regular expressions of the Python `surt` library's
//! `IAURLCanonicalizer`, including their quirks. The patterns can match inside parameters rather
//! than only at their boundaries, and removing a final query parameter can leave its preceding
//! `&` behind.
